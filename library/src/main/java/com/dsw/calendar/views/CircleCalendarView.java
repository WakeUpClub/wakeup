        ...
        circleMonthView.setMonthLisener(new MonthView.IMonthLisener() {
            ...
            public void setTextMonth() {
                ...
                if(onMonthChangeListener!=null){
                    onMonthChangeListener.onMonthChanged(circleMonthView.getSelYear(),circleMonthView.getSelMonth());
                }
            }
        });
    }
...
//    }
    ...
    public void setCalendarInfos(int year, int month, ArrayList<Integer> days){
       this.circleMonthView.setCalendarInfos(year,month,days);
    }
